 ...
 * @param filename
 */
function checkAndReadFile(filename) {
 ...
 * @param text
 */
function getFirstUniqueCharIndex(text) {
    let output = -1;
...
if (process.argv.length >= 4) {
    ...
    const content = process.argv.includes('-i') || process.argv.includes('--inline') ? input : checkAndReadFile(input !== null && input !== void 0 ? input : '');
    console.log('Output: ' + getFirstUniqueCharIndex(content !== null && content !== void 0 ? content : '').toString());
}
else {
